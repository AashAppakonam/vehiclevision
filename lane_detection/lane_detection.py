# console input: python lane_detect.py -i test_vids\.mp4 -o output_vids
# or: python lane_detect.py -i "__file_path" -o output_vids
...
ap.add_argument("-o", "--output", type=str, required=True,
	help="base path to output video")
args = vars(ap.parse_args())

# warning message
print("\n[WARNING] Make sure to rename previous video file, otherwise current process will overwrite file.")
...
myclip = VideoFileClip(args["input"])#.subclip(40,43)
output_vid = 'output.mp4'
# resizing algorithm
if myclip.w != 1280 or myclip.h != 720:
	print("\n[INFO] Resizing...\n")
	clip_resized = myclip.resize((1280, 720)) #(w,h)
else:
	clip_resized = myclip
	print("\n[INFO] No resizing needed\n")

clip = clip_resized.fl_image(vid_pipeline)
clip.write_videofile(output_vid, audio=False)

shutil.move(output_vid, args["output"])
print("\n[INFO] Finished!\n")
