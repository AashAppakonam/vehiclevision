#console input: python yolo_image.py -i images\_.jpg -y yolo-coco -c _ -t _
...
ap.add_argument("-c", "--confidence", type=float, default=0.51,
...
print("\nObjects Detected w/ confidences: ", objects)
